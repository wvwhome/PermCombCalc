#  File web_app.py
#
#  03/07/2019 WVW: Permuations-Combinations Calculator.
#  03/25/2019 WVW: Deploy version 2.0 in AWS Lambda.
#     Using zappa init
#           zappa deploy dev
#           zappa update dev
#
...
from forms import PermEnumForm
from flask import render_template, url_for, flash, redirect, request
#
from forms import PermEnumForm
from forms import PermEnumWordForm
from forms import PermGenerateForm
from forms import edit_dupes_string
        ...
        if raw_perm_count <= raw_perm_limit  or  \
           raw_perm_limit == -1:            
            if cooked_perm_count <= display_limit:    
                ...
                if form_gen.submit_word.data == True:
                        perm_display_list = []
                ...
                generate_count = len(perm_display_list)                
